...
interface BasicArrowLeftIconProps {
    size?: number;
    color?: string;
    className?: string;
}

const BasicArrowLeftIcon: React.FC<BasicArrowLeftIconProps> = ({ size = 32, color = 'currentColor', className = '' }) => {
    return (
        <svg
            viewBox="0 0 18 16"
            fill="none"
...
export default BasicArrowLeftIcon;