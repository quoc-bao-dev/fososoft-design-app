...
const FosoOriginIcon2: React.FC<FosoOriginIconProps> = ({
    size = 32,
    style = {},
    className = "",
    color = "url(#paint0_linear)", // Lấy màu mặc định từ SVG
}) => {
    return (
        <svg
            width={size}
            ...
            style={{ ...style }}
        >
            {/* Định nghĩa gradient gốc */}
            <defs>
                <linearGradient id="paint0_linear" x1="8.5" y1="10.93" x2="20.4" y2="42.48" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#0375F3" />
                    <stop offset="1" stopColor="#25387A" />
                </linearGradient>
                <linearGradient id="paint1_linear" x1="26.84" y1="21.19" x2="20.55" y2="44.90" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#1FC583" />
                    <stop offset="1" stopColor="#1F9285" />
                </linearGradient>
                <linearGradient id="paint2_linear" x1="16.85" y1="17.05" x2="16.85" y2="28.49" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#0375F3" />
                    <stop offset="1" stopColor="#013DA0" />
                </linearGradient>
            </defs>

            {/* Sử dụng màu mặc định từ SVG */}
            ...
            <path d="M24.5516 8.385L30.2916 14.125C32.4916 16.325 33.7016 19.245 33.7016 22.365C33.7016 25.475 32.4916 28.395 30.2916 30.595L26.9516 33.935C25.1216 35.765 22.1516 35.795 20.2916 34.005L16.8516 30.565L23.5616 23.855C23.9616 23.455 24.1816 22.915 24.1816 22.355C24.1816 21.785 23.9616 21.245 23.5616 20.845C22.0116 19.295 21.1716 17.265 21.1716 15.105C21.1716 12.945 22.0116 10.915 23.5416 9.395L24.5616 8.375L24.5516 8.385Z"
                fill={color}
            />
            <path d="M16.8466 17.5664L20.7851 21.505C21.2518 21.9717 21.2518 22.7354 20.7851 23.202L16.8466 27.1406L12.908 23.202C12.4413 22.7354 12.4413 21.9717 12.908 21.505L16.8466 17.5664Z"
                fill={color}
            />
        </svg>
    );
...
export default FosoOriginIcon2;
