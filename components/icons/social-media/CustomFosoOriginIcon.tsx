...
interface CustomFosoOriginIconProps {
    size?: number;
    color?: string;
    className?: string;
}

const CustomFosoOriginIcon: React.FC<CustomFosoOriginIconProps> = ({ size = 32, color = 'currentColor', className = '' }) => {
    return (
        <svg
            viewBox="0 0 34 45"
            fill="none"
...
export default CustomFosoOriginIcon;