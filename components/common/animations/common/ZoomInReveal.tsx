...
const ZoomInReveal: React.FC<ZoomInRevealProps> = ({
    children,
    delay = 0,
    duration = 0.8,
    from,
    ...
    const variants = {
        hidden: {
            opacity: 0,
            scale: 0.85, // Bắt đầu nhỏ
            x: from ? xMove : 0,
            y: from ? yMove : 0,
        },
        visible: {
            opacity: 1,
            scale: [0.85, 1.05, 1], // Hiệu ứng phóng to nhẹ rồi về kích thước chuẩn
            x: 0,
            y: 0,
            transition: {
