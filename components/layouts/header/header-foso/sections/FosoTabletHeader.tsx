...
const FosoTabletHeader: React.FC<TabletHeaderProps> = ({
  ...
  const handleToggleSubMenu = (id: string) => {
    let active =
      isStateClientLayout?.header?.isActiveSubMenuFoso === id ? null : id;
                  ...
                  <React.Fragment key={`menu-${data.id}`}>
                    {data.subMenu ? (
                      ...
                      <React.Fragment>
                            ...
                            className={`text-2xl font-medium transition-all 
                                                                        ${
                                                                          ...
                                                                          (pathname.includes(
                                                                            ...
                                                                            data.link !==
                                                                              "/")
                                                                            ? "text-[#10805B] font-medium decoration-[3px] decoration-[#25272A]/90"
                                                                            : "text-[#25272A]"
                                                                        }
                                                                        ${
                                                                          isStateClientLayout
                        ...
                        {/* Submenu Animation */}
                        <AnimatePresence>
                          {isStateClientLayout?.header?.isActiveSubMenuFoso ===
                            data.id && (
                            <motion.div
                                      ...
                                      {data?.subMenu?.content[tab]?.items?.map(
                                        (item) => (
                                          ...
                                          >
                                            <div
                                              className={`${
                                                item.typeIcon === "default"
                                                  ? "border-[#15AA7A]"
                                                  : "border-transparent"
                                              } size-12 flex items-center justify-center border  rounded-xl shrink-0`}
                                            >
                                              <div
                                                className={`${
                                                  item.typeIcon === "default"
                      ...
                      <div
                        ...
                        className={`${
                          ...
                          (pathname.includes(data.link) && data.link !== "/")
                            ? "text-[#10805B] font-medium decoration-[3px] decoration-[#25272A]/90"
                            : "text-[#25272A]"
                        } text-2xl w-fit duration-300 transition ease-in-out flex items-center font-medium md:px-8 px-6 cursor-pointer`}
                        onClick={() => {
                          const sectionId = getSectionId(data.link);
                          if (sectionId) {
                            handleHeaderMenuClick(
                              data.link,
                              pathname,
