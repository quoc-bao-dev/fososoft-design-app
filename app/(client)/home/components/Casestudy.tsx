        ...
        <div className="space-x-2 font-extrabold text-center">
          <span className="text-title-section-small text-[#1A2025] capitalize">
            ...
            <span
              ...
              style={{
                background:
                  "linear-gradient(107.4deg, #9DFFB3 0%, #1AA37A 100%)",
        ...
        {isVisibleTablet ? (
          <div className="w-full ">
            {isLoading ? (
              ...
              >
                {projectList &&
                  projectList?.data?.map((media: any) => (
          ...
          <div className="grid grid-cols-3 3xl:gap-6 gap-4 w-full">
            {isLoading
              ...
              : projectList &&
                projectList?.data?.map((media, index) => (
            ...
            <div className="2xl:size-12 md:size-10 size-9 rounded-full capitalize flex items-center justify-center group-hover:bg-[#024EBC] group-hover:text-white duration-500 transition-colors">
              ...
              >
                {isHovered ? (
                  ...
                  <ArrowUpRightLinearBlueIcon className="2xl:size-6 md:size-5 size-4 text-[#0375F3] group-hover:text-white" />
                )}
              </motion.div>
            </div>
          }
