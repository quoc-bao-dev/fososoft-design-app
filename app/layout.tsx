...
export const metadata = getMetadata({
  title: "FOSO - Dịch vụ thiết kế app mobile tận tâm",
  description:
    "Thiết kế app mobile tại FOSO mang đến giải pháp app mobile hiệu quả, phù hợp với từng nhu cầu doanh nghiệp với giao diện thân thiện, đẹp mắt.",
